...
int main() {
	struct person person1 = {"WangHua", 18u, 'F', 120.0f};
	struct person person2 = {.name = "WangHua", .age = 18u, .sex = 'F', .weight = 120.0f};
	struct person person3 = {name : "WangHua", age : 18u, sex : 'F', weight : 120.0f};
